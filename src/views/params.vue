<template>
  <div>
    <!-- 面包屑导航 -->
    <mybread name1="商品管理" name2="分了参数"></mybread>
    <!-- alert -->
    ...
    <el-tabs class="my-tabs" v-model="activeName">
      <el-tab-pane label="动态参数" name="first">
        <el-button class="my-button" type="primary">添加动态参数</el-button>
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="info" label="商品参数" width="180"></el-table-column>
      ...
      <el-tab-pane label="静态参数" name="second">
        <el-button class="my-button" type="primary">添加静态参数</el-button>
        <el-table :data="tableData" style="width: 100%">
  ...
  data() {
    return {
      ...
      tableData: [
        ...
        {
          info: "内存",
          list: ["4g", "8g", "16g", "32g", "64g"]
        },
        {
          info: "cpu主频",
          list: ["1.0Ghz", "2.5Ghz", "2.6Ghz"]
        }
      ],
      // tab绑定的值
      activeName: "second",
